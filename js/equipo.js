...
const Navbar = () => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("nav", {
    ...
    style: {
      fontSize: 13.5,
      fontWeight: 500,
      color: l.href === 'equipo.html' ? 'var(--txt)' : 'var(--txt-s)',
      textDecoration: 'none',
      transition: 'color .2s'
    },
    onMouseEnter: e => e.target.style.color = 'var(--txt)',
    onMouseLeave: e => e.target.style.color = l.href === 'equipo.html' ? 'var(--txt)' : 'var(--txt-s)'
...
const TeamSection = () => {
  const T = [{
    ...
    skills: ['Ciberseguridad', 'Infraestructura', 'Sistemas IT', 'DevOps', 'Redes']
  }, {
    i: 'A',
    g: 'linear-gradient(135deg,#7c3aed,#1a56db)',
    n: 'Abner',
    r: 'Developer Senior · Web & Apps',
    b: 'Desarrollador senior con amplia experiencia en aplicaciones web de alto rendimiento. Transforma requisitos complejos en productos digitales claros, precisos y bien construidos.',
    skills: ['React / Next.js', 'Node.js', 'PostgreSQL', 'TypeScript', 'APIs REST']
  }, {
    i: 'L',
    g: 'linear-gradient(135deg,#0f766e,#0d9488)',
    n: 'Elias',
    r: 'Developer · Web & Apps · Empresario',
    b: 'Desarrollador de aplicaciones con visión empresarial. Combina criterio técnico y enfoque de negocio para construir productos que generan valor real y duradero para cada cliente.',
    skills: ['PHP / WordPress', 'Flutter', 'Firebase', 'E-commerce', 'Estrategia digital']
  }];
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "sh-d"
  }, "Equipo t\xE9cnico con experiencia en sistemas IT, seguridad, desarrollo y aplicaciones. Equipo remoto, con acompa\xF1amiento directo en cada proyecto.")), /*#__PURE__*/React.createElement("div", {
    className: "g3"
  ...
  }, t.skills.map(s => /*#__PURE__*/React.createElement("span", {
    key: s,
    style: {
      fontSize: 10.5,
      fontWeight: 600,
...
const ValuesSection = () => {
  const V = [{
    icon: '🎯',
    title: 'Foco en negocio',
    desc: 'Cada decisión técnica tiene que servir a un objetivo de negocio concreto. No construimos por construir.'
  }, {
    icon: '🔍',
    title: 'Transparencia total',
    desc: 'Precio cerrado, plazos reales, comunicación directa. Sin letra pequeña ni sorpresas de última hora.'
  }, {
    icon: '⚡',
    title: 'Velocidad con criterio',
    desc: 'Rápido no significa descuidado. Entregamos deprisa porque tenemos un proceso afinado, no porque cortemos esquinas.'
  }, {
    icon: '🔒',
    title: 'Seguridad por defecto',
    desc: 'Cada proyecto incluye prácticas de seguridad desde el diseño: HTTPS, protección DDoS, backups y monitorización.'
  }];
  return /*#__PURE__*/React.createElement("section", {
    className: "sec",
    style: {
    ...
    className: "sh-t"
  }, "Los principios que gu\xEDan cada proyecto.")), /*#__PURE__*/React.createElement("div", {
    className: "g4 rev"
  }, V.map((v, i) => /*#__PURE__*/React.createElement("div", {
    key: v.title,
    className: `card d${i + 1}`,
    style: {
      textAlign: 'center',
      alignItems: 'center'
    }
...
}, "Estudio tech premium. Dise\xF1o, desarrollo y seguridad con criterio t\xE9cnico y foco en negocio.")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
  className: "fh"
...
const StickyBar = () => {
  ...
  }, /*#__PURE__*/React.createElement("strong", null, "\xBFQuieres trabajar con nuestro equipo?"), " Primera consulta gratuita."), /*#__PURE__*/React.createElement("a", {
    href: "contacto.html",
    className: "btn btn-p",
    style: {
      padding: '9px 18px',
...
const App = () => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Navbar, null), /*#__PURE__*/React.createElement("section", {
    ...
    className: "dot"
  }), "Nuestro equipo")), /*#__PURE__*/React.createElement("h1", {
    className: "h1 ha2",
    style: {
      marginTop: 20,
      maxWidth: '44rem',
  ...
  }, "Personas reales detr\xE1s de ", /*#__PURE__*/React.createElement("em", null, "cada proyecto.")), /*#__PURE__*/React.createElement("p", {
    className: "ha3",
    style: {
      marginTop: 16,
  ...
  }, "Un equipo t\xE9cnico peque\xF1o, directo y especializado. Trabajamos con empresas de cualquier pa\xEDs, 100% en remoto."))), /*#__PURE__*/React.createElement(TeamSection, null), /*#__PURE__*/React.createElement(ValuesSection, null), /*#__PURE__*/React.createElement("section", {
    className: "sec"
  }, /*#__PURE__*/React.createElement("div", {
    className: "wrap"
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      background: 'linear-gradient(135deg,rgba(124,58,237,0.07),rgba(26,86,219,0.07))',
  ...
  }, "Trabaja directamente con nosotros."), /*#__PURE__*/React.createElement("p", {
    style: {
      marginTop: 14,
      fontSize: 'clamp(14px,1.9vw,17px)',
      lineHeight: 2,
  ...
  }, "Sin intermediarios. Sin gestores de cuenta. Hablas con quien construye tu proyecto."), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 28,
      display: 'flex',
      gap: 14,
    ...
    href: "contacto.html",
    className: "btn btn-p"
  }, "Hablar con el equipo \u2192"), /*#__PURE__*/React.createElement("a", {
    href: "mailto:contacto@nexo-digital.app",
    className: "btn btn-teal"
  }, "\u2709 Email directo"))))), /*#__PURE__*/React.createElement(Footer, null), /*#__PURE__*/React.createElement(StickyBar, null), /*#__PURE__*/React.createElement(ChatWidget, null), /*#__PURE__*/React.createElement(ScrollFab, null), /*#__PURE__*/React.createElement(WaFab, null));
};
