...
const Navbar = () => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("nav", {
    ...
    style: {
      fontSize: 13.5,
      fontWeight: 500,
      color: l.href === 'equipa.html' ? 'var(--txt)' : 'var(--txt-s)',
      textDecoration: 'none',
      transition: 'color .2s'
    },
    onMouseEnter: e => e.target.style.color = 'var(--txt)',
    onMouseLeave: e => e.target.style.color = l.href === 'equipa.html' ? 'var(--txt)' : 'var(--txt-s)'
...
const TeamSection = () => {
  const T = [{
    ...
    b: 'Especialista em infraestrutura IT, cibersegurança e arquitetura de sistemas. Garante que cada projeto é lançado sobre uma base robusta, segura e escalável.',
    skills: ['Cibersegurança', 'Infraestrutura', 'Sistemas IT', 'DevOps', 'Redes']
  }, {
    i: 'A',
    g: 'linear-gradient(135deg,#7c3aed,#1a56db)',
    n: 'Abner',
    r: 'Developer Sénior · Web & Apps',
    b: 'Desenvolvedor sénior com vasta experiência em aplicações web de alto desempenho. Transforma requisitos complexos em produtos digitais claros, precisos e bem construídos.',
    ...
    b: 'Desenvolvedor de aplicações com visão empresarial. Combina critério técnico e foco em negócio para construir produtos que geram valor real e duradouro para cada cliente.',
    skills: ['PHP / WordPress', 'Flutter', 'Firebase', 'E-commerce', 'Estratégia digital']
  }];
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "sh-d"
  }, "Equipa t\xE9cnica com experi\xEAncia em sistemas IT, seguran\xE7a, desenvolvimento e aplica\xE7\xF5es. Equipa remota, com acompanhamento direto em cada projeto.")), /*#__PURE__*/React.createElement("div", {
    className: "g3"
...
const ValuesSection = () => {
  const V = [{
    ...
    desc: 'Cada decisão técnica tem de servir um objetivo de negócio concreto. Não construímos por construir.'
  }, {
    icon: '🔍',
    title: 'Transparência total',
    desc: 'Preço fechado, prazos reais, comunicação direta. Sem letra pequena nem surpresas de última hora.'
  }, {
    icon: '⚡',
    title: 'Velocidade com critério',
    desc: 'Rápido não significa descuidado. Entregamos depressa porque temos um processo afinado, não porque cortamos caminho.'
  }, {
    icon: '🔒',
    title: 'Segurança por defeito',
    desc: 'Cada projeto inclui práticas de segurança desde a conceção: HTTPS, proteção DDoS, backups e monitorização.'
  }];
  return /*#__PURE__*/React.createElement("section", {
    className: "sec",
    style: {
    ...
    className: "sh-t"
  }, "Os princ\xEDpios que orientam cada projeto.")), /*#__PURE__*/React.createElement("div", {
    className: "g4 rev"
...
}, "Ag\xEAncia tech premium. Design, desenvolvimento e seguran\xE7a com crit\xE9rio t\xE9cnico e foco em neg\xF3cio.")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
  className: "fh"
...
const App = () => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Navbar, null), /*#__PURE__*/React.createElement("section", {
    ...
    className: "dot"
  }), "A nossa equipa")), /*#__PURE__*/React.createElement("h1", {
    className: "h1 ha2",
    style: {
      marginTop: 20,
      maxWidth: '44rem',
  ...
  }, "Pessoas reais por detr\xE1s de ", /*#__PURE__*/React.createElement("em", null, "cada projeto.")), /*#__PURE__*/React.createElement("p", {
    className: "ha3",
    style: {
      marginTop: 16,
  ...
  }, "Uma equipa t\xE9cnica pequena, direta e especializada. Trabalhamos com empresas de qualquer pa\xEDs, 100% \xE0 dist\xE2ncia."))), /*#__PURE__*/React.createElement(TeamSection, null), /*#__PURE__*/React.createElement(ValuesSection, null), /*#__PURE__*/React.createElement("section", {
    className: "sec"
  }, /*#__PURE__*/React.createElement("div", {
    className: "wrap"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Trabalhe diretamente connosco."), /*#__PURE__*/React.createElement("p", {
    style: {
      marginTop: 14,
      fontSize: 'clamp(14px,1.9vw,17px)',
      lineHeight: 2,
  ...
  }, "Sem intermedi\xE1rios. Sem gestores de conta. Fala com quem constr\xF3i o seu projeto."), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 28,
      display: 'flex',
      gap: 14,
  ...
  }, "\u2709 Email direto"))))), /*#__PURE__*/React.createElement(Footer, null), /*#__PURE__*/React.createElement(StickyBar, null), /*#__PURE__*/React.createElement(ChatWidget, null), /*#__PURE__*/React.createElement(ScrollFab, null), /*#__PURE__*/React.createElement(WaFab, null));
};
